...
<head>
	...
	<title>SottomenuFatturaPassiva</title>
	...
	<script type="text/javascript">
		function sceltaMenu(){
			...
			if(i<scelta.length){
				window.location.href = "sottomenu-fattura-passiva/" + scelta[i].value;
			}
		}
	</script>
</head>
...
<a class="btn btn-secondary" href="${backUrl}" role="button">Indietro</a>
	...
	<div class="container"> 
		<h2 align="center">Fattura Passiva</h2>
		<br>
		<DIV align="center">
			<table>
				<tr>
					<td><INPUT type="radio" name="scelta" value="registrazione" checked="checked"></td>
					<td>Registrazione</td>
				</tr>
				<tr>
				...
				<tr>
					<td><INPUT type="radio" name="scelta" value="statistica"></td>
					<td>Statistica</td>
				</tr>
			</table>
			<br>
