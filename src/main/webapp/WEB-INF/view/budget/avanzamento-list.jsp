...
<!-- 					</td> -->
			...
			<script type="text/javascript" >
				function caricaLista(chiaveArea){
					if(chiaveArea!="")
						window.location.href = "/budget/search-avanzamento/" + chiaveArea;
				}
			</script>	
								...
								<tbody>
									<c:forEach items="${listSottocategorie}" var="currentSottocategoria">
										<tr>
											...
											<td>${currentSottocategoria.budgetSpeso}</td>
											<td>${currentSottocategoria.budget - currentSottocategoria.budgetSpeso}</td>
										</tr>
									</c:forEach>
										<tr>
