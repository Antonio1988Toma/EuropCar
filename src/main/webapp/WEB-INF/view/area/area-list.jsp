						...
						<tbody>
							<c:forEach items="${list}" var="currentArea">
								<tr>
									...
									<td>${currentArea.nomeArea}</td>
									<td>${currentArea.annoContabile.descrizione}</td>
									<td>
										<spring:url value="/area/update/${currentArea.id }" var="updateUrl"  />
										<a class="btn btn-warning" href="${updateUrl}" role="button">Modifica</a>
									</td>
									<td>
										<spring:url value="/area/delete/${currentArea.id }" var="deleteUrl"  />
										<a class="btn btn-danger" href="${deleteUrl}" role="button" onclick="return confirm('Eliminare l\'Area selezionata?')">Elimina</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
