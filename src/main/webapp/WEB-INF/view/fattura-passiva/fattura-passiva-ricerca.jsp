...
<a class="btn btn-secondary" href="${backUrl}" role="button">Indietro</a>
	...
	<div class="container"> 
		...
		<DIV align="center">
			<table>
				<tr>
					<td><INPUT type="radio" name="scelta" value="ricerca-sottocategoria" checked="checked"></td>
					<td>Ricerca per Sottocategoria</td>
				</tr>
				<tr>
					<td><INPUT type="radio" name="scelta" value="ricerca-fornitore"></td>
					<td>Ricerca per Fornitore</td>
				</tr>
				<tr>
					<td><INPUT type="radio" name="scelta" value="ricerca-preventivo"></td>
					<td>Ricerca per Preventivo</td>
				</tr>
			</table>
			<br>
			<DIV>
